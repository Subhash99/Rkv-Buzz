...
public class StudentClubEd extends AppCompatActivity {

    ListView listViewEx;
    DatabaseReference databaseExams;
    List<StudentClubs> scList;
    List<String> keyList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_club_ed);
        firebaseAuth = FirebaseAuth.getInstance();
        databaseExams= FirebaseDatabase.getInstance().getReference("StudentClubs");
        ...
        databaseExams.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    StudentClubs sc=exSnapshot.getValue(StudentClubs.class);
                    scList.add(sc);
                    keyList.add(exSnapshot.getKey());
                }
                Collections.reverse(scList);
                Collections.reverse(keyList);
                ScList adapter=new ScList(StudentClubEd.this,scList);
        ...
        listViewEx.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                StudentClubs sc=scList.get(position);
                showUpdateDialog(keyList.get(position),sc.getHeader(),sc.getDescription(),sc.getLocalLink(),sc.getPublicLink(),sc.getUrl());
                return false;
            }
        });
    }
    ...
    {
        AlertDialog.Builder dialogBuilder=new AlertDialog.Builder(StudentClubEd.this);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref=FirebaseDatabase.getInstance().getReference("StudentClubs").child(key);
                SimpleDateFormat currentDate = new SimpleDateFormat("dd/MM/yyyy");
                Date todayDate = new Date();
                String thisDate = currentDate.format(todayDate);
                StudentClubs scs=new StudentClubs(p,l,h,d,thisDate,url);
                myref.setValue(scs);
                alertDialog.dismiss();
            }
        });
    ...
    {
        DatabaseReference myref=FirebaseDatabase.getInstance().getReference("StudentClubs").child(id);
        myref.removeValue();
        keyList.remove(id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.insertex:
                Intent i=new Intent(getApplicationContext(),StudentClubSection.class);
                startActivity(i);
                return true;
            case R.id.logout:
