...
public class AcadamicsEd extends AppCompatActivity {

    ListView listViewEx;
    DatabaseReference databaseExams;
    List<Acadamics> acList;
    List<String> keyList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acadamics_ed);
        firebaseAuth = FirebaseAuth.getInstance();
        databaseExams= FirebaseDatabase.getInstance().getReference("Acadamics");
        ...
        databaseExams.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Acadamics ac=exSnapshot.getValue(Acadamics.class);
                    acList.add(ac);
                    keyList.add(exSnapshot.getKey());
                }
                Collections.reverse(acList);
                Collections.reverse(keyList);
                AcList adapter=new AcList(AcadamicsEd.this,acList);
        ...
        listViewEx.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                showUpdateDialog(keyList.get(position),ac.getHeader(),ac.getDescription(),ac.getLocalLink(),ac.getPublicLink(),ac.getUrl());
                return false;
            }
        });
    }
    ...
    {
        AlertDialog.Builder dialogBuilder=new AlertDialog.Builder(AcadamicsEd.this);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref=FirebaseDatabase.getInstance().getReference("Acadamics").child(key);
                SimpleDateFormat currentDate = new SimpleDateFormat("dd/MM/yyyy");
                Date todayDate = new Date();
                String thisDate = currentDate.format(todayDate);
                Acadamics aca=new Acadamics(p,l,h,d,thisDate,url);
                myref.setValue(aca);
                alertDialog.dismiss();
            }
        });
    ...
    {
        DatabaseReference myref=FirebaseDatabase.getInstance().getReference("Acadamics").child(id);
        myref.removeValue();
        keyList.remove(id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.insertex:
                Intent i=new Intent(getApplicationContext(),AcadamicSection.class);
                startActivity(i);
                return true;
            case R.id.logout:
