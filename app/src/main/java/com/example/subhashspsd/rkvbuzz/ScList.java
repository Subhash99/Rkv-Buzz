...
public class ScList extends ArrayAdapter<StudentClubs> {

    private Activity context;
    private List<StudentClubs> scList;
    int img=R.drawable.ic_attachment_black_24dp;
    public ScList(Activity context,List<StudentClubs> scList)
    {
        super(context,R.layout.singlerow,scList);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        StudentClubs ac=scList.get(position);
