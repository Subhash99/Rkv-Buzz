...
public class StudentClubSection extends AppCompatActivity {
    ...
    DatabaseReference mDatabase=fd.getReference("StudentClubs");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_club_section);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                {
                    if (ContextCompat.checkSelfPermission(StudentClubSection.this, android.Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                        selectPdf();
                    } else
                        ActivityCompat.requestPermissions(StudentClubSection.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
                }
            }
        });
    }
    ...
    public void InsertData(View view) {
        ...
        if(!(TextUtils.isEmpty(Desc)))
        {
            ...
            /*StudentClubs ex=new StudentClubs(PublicLink,LocalLink,Header,Desc,thisDate);
    ...
    private void uploadFile() {
        ...
        storageReference.child("StudentUploads").child(filename).putFile(pdfUri)
    ...
    private void work(String url) {
        ...
        Date todayDate = new Date();
        String thisDate = currentDate.format(todayDate);
        ex=new StudentClubs(PublicLink,LocalLink,Header,Desc,thisDate,url);
        mDatabase.child(id).setValue(ex);
        Notify nt =new Notify();
        nt.execute(Header,Desc);
        Toast.makeText(getApplicationContext(),"Successfull",Toast.LENGTH_SHORT).show();
        Intent i=new Intent(this,StudentClubEd.class );
        startActivity(i);
